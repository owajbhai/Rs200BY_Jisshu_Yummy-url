...
USERNAME = environ.get('USERNAME', "https://t.me/Kaifjio") # ADMIN USERNAME
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001860172104'))
MOVIE_GROUP_LINK = environ.get('MOVIE_GROUP_LINK', 'https://t.me/')
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002294203953').split()]
#---------------------------------------------------------------
#---------------------------------------------------------------
