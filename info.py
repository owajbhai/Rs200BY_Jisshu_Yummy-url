...
BOT_TOKEN = environ.get('BOT_TOKEN', '7590914619:AAFkOgKMy6K86-zrfCdZroqjBkxMAS9mpTI')
#---------------------------------------------------------------
#---------------------------------------------------------------
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1249672673 7638075280').split()]
...
#---------------------------------------------------------------
#---------------------------------------------------------------
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Sujay53728283838:Sujay53728283838@cluster02993858594.8fts1dy.mongodb.net/?retryWrites=true&w=majority&appName=Cluster02993858594")
...
DELETE_CHANNELS = int(environ.get('DELETE_CHANNELS','-1001551886347')) # The movie you upload in it will be deleted from the bot.
...
#---------------------------------------------------------------
#---------------------------------------------------------------
START_IMG = (environ.get('START_IMG', 'https://i.ibb.co/PzxFq6R0/43400e676b5e.jpg https://i.ibb.co/PzxFq6R0/43400e676b5e.jpg')).split()
FORCESUB_IMG = environ.get('FORCESUB_IMG', 'https://i.ibb.co/PzxFq6R0/43400e676b5e.jpg')
REFER_PICS = (environ.get("REFER_PICS", "https://i.ibb.co/PzxFq6R0/43400e676b5e.jpg")).split() 
PAYPICS = (environ.get('PAYPICS', 'https://i.ibb.co/PzxFq6R0/43400e676b5e.jpg')).split()
SUBSCRIPTION = (environ.get('SUBSCRIPTION', 'https://i.ibb.co/PzxFq6R0/43400e676b5e.jpg'))
REACTIONS = ["👀", "😱", "🔥", "😍", "🎉", "🥰", "😇", "⚡"]
#---------------------------------------------------------------
#---------------------------------------------------------------
#---------------------------------------------------------------
